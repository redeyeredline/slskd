...
const getIcon = ({ state, ...props }) => {
  switch (state) {
    ...
    case "InProgress":
      return <Icon color="green" loading name="circle notch" {...props} />;
    case "Completed, TimedOut":
    case "Completed, ResponseLimitReached":
    case "Completed, FileLimitReached":
      return <Icon color="green" name="check" {...props} />;
    case "Completed, Cancelled":
      return <Icon color="green" name="stop circle" {...props} />;
    case "Completed, Errored":
      return <Icon color="red" name="x" {...props} />;
    default:
      return <Icon color="yellow" name="question circle" {...props} />;
  }
};
